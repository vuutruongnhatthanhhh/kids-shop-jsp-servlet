          ...
          <div class="col-md-12">
            <form action="ChangePass" method="post">
              <div class="form-group row">
                <label for="oldpassword" class="col-4 col-form-label">Mật khẩu hiện tại</label>
                <div class="col-8">
                  <input name="oldpassword"
                         class="form-control here" required="required" type="password" id="oldpassword">
                </div>
              </div>
              <div class="form-group row">
                <label for="newpassword" class="col-4 col-form-label">Mật khẩu mới</label>
                <div class="col-8">
                  <input name="newpassword" class="form-control here"
                         type="password" id="newpassword">
                </div>
              </div>
              <div class="form-group row">
                <label for="re_newpassword" class="col-4 col-form-label">Nhập lại mật khẩu mới</label>
                <div class="col-8">
                  <input name="re_newpassword"
                         class="form-control here" type="password" id="re_newpassword">
                </div>
              </div>
