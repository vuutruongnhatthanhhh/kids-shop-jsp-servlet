...
@WebServlet(name = "UpdateProductStorage", value = "/UpdateProductStorage")
public class UpdateProductStorage extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("AdminWeb/updateProductStorage.jsp").forward(request, response);
    }
